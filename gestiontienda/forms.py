...
class PedidoCarritoFormEditar(PedidoCarritoForm):
    ...
    fecha_creacion = forms.DateField(label=("Fecha de creación"),
                widget=forms.DateInput(attrs={'class':class_attr_inputs, 'readonly':True, 'disabled':True}),required=False)
    ...
    precio_total = forms.IntegerField(label="Precio del Carrito (CLP)",
                widget=forms.TextInput(attrs={'class':class_attr_inputs,'placeholder':'Ingresar valor del pedido','disabled':True},),
                help_text=(""),required=False)
...
class PedidoServicioFormEditar(PedidoServicioForm):
    ...
    nombre = forms.CharField(label=("Servicio"),
                widget=forms.TextInput(attrs={'class':class_attr_inputs,'disabled':True}),required=False)
    ...
    fecha_creacion = forms.DateField(label=("Fecha de creación"),
                widget=forms.DateInput(attrs={'class':class_attr_inputs,'disabled':True}),required=False)
